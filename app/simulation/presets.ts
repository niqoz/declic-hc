...
export const APPLIANCE_PRESETS: AppliancePreset[] = [
  { type: "water-heater", name: "Chauffe-eau", annualKwh: waterHeater, lowKwh: waterHeaterLow, highKwh: waterHeaterHigh, calculationMode: "reference", source: source("water-heater"), icon: "♨", detail: "Ballon électrique" },
  { type: "electric-vehicle", name: "Véhicule électrique", annualKwh: 2000, lowKwh: 1000, highKwh: 3000, calculationMode: "reference", source: source("electric-vehicle"), icon: "⚡", detail: "Recharge à domicile" },
  { type: "pool-pump", name: "Pompe de piscine", annualKwh: 900, lowKwh: 500, highKwh: 1500, calculationMode: "reference", source: source("pool-pump"), icon: "≈", detail: "Filtration programmable" },
  { type: "heat-pump-water-heater", name: "Ballon thermodynamique", annualKwh: 500, lowKwh: 350, highKwh: 800, calculationMode: "reference", source: source("heat-pump-water-heater"), icon: "◌", detail: "Eau chaude optimisée" },
...
export const DEFAULT_APPLIANCES: Appliance[] = [
  applianceFromPreset("Chauffe-eau", 1),
  applianceFromPreset("Lave-linge", 2),
  applianceFromPreset("Lave-vaisselle", 3),
];
