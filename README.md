...
Les modèles reposant sur moins de 30 logements restent marqués « fiabilité insuffisante » et ne reçoivent pas de coefficient automatique. Les usages calibrés suivent la consommation annuelle du foyer par l’exposant mesuré contre le reste du logement, appliqué à la consommation par habitant. La correction selon le nombre d’habitants s’y ajoute ; elle est volontairement signalée comme indicative, cette variable n’étant pas publiée par logement dans le fichier ouvert. Les deux corrections sont sous-linéaires, avec un exposant propre à chaque usage.

La répartition HP/HC conserve par hypothèse 100 % des usages flexibles sélectionnés en heures creuses. La climatisation estivale constitue l’exception : elle suit un usage diurne dépendant de la présence du foyer. Le chauffage, qui ne dispose pas d’un réglage d’accumulation, n’est compté en HC que pour les besoins ayant naturellement lieu pendant la plage tarifaire de huit heures ; ces besoins sont pondérés par l’écart entre la consigne et une température extérieure journalière, ce qui donne aux heures nocturnes le poids que leur froideur leur confère. Les estimations basse et haute alimentent une fourchette de facture qui encadre le scénario central et s’affiche sous le résultat ; le chauffage retenu y contribue avec la marge relative de son modèle. Le verdict suit cette fourchette : il n’est prononcé que si elle ne traverse pas zéro.
